...
def _normalise_type(raw_type: str, fallback: str) -> str:
    """Map any model type variant to the canonical type name."""
...
class QuestionEngine:
    ...
    def generate(
        ...
        for i in range(num_questions):
            ...
            if question:
                # Store the source context so the evaluator can check relevance later.
                # Prefixed with _ so it's stripped before returning to the API caller.
    ...
    def _parse_json(
        ...
        def _try_parse(text: str) -> dict | None:
            try:
                ...
                # Normalise type name — model sometimes returns variants
